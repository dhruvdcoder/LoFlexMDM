...
def postprocess_preds_and_targets_to_same_shape(
    batch: Dict[str, Any], loss_dict: Dict[str, Any], tokenizer: Any
) -> Dict[str, Any]:
    ...
    for _pred, _target in zip(truncated_preds, truncated_targets):
        ...
        padded_preds.append(
            _pred + [tokenizer.pad_token_id] * (max_len - len(_pred))
        )
        padded_targets.append(
            _target + [tokenizer.pad_token_id] * (max_len - len(_target))
        )
...
def seq2seq_exact_match_update_fn(
    ...
    return postprocess_preds_and_targets_to_same_shape(
        batch, loss_dict, tokenizer
    )
...
def mean_unmask_loss_update_fn(
    batch: Dict[str, Any], loss_dict: Dict[str, Any], tokenizer: Any = None
) -> Dict[str, Any]:
    """Update function for mean loss metric.
    ...
    """
    return {
        "value": loss_dict["unmask_loss"],
    }


def mean_insertion_loss_update_fn(
    batch: Dict[str, Any], loss_dict: Dict[str, Any], tokenizer: Any = None
) -> Dict[str, Any]:
    """Update function for mean loss metric.
    ...
    """
    return {
        "value": loss_dict["insertion_loss"],
    }


def mean_reg_loss_update_fn(
    batch: Dict[str, Any], loss_dict: Dict[str, Any], tokenizer: Any = None
) -> Dict[str, Any]:
    """Update function for mean loss metric.
